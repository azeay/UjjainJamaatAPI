...
{
    public abstract class SeatAllocationWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SeatAllocationWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SeatAllocationWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SeatAllocationDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SeatAllocationDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SeatAllocationDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SeatAllocationDbContext, Task<T>> func)
        {
            T result;
